...
export default function Hero() {
  ...
  // Floating pill data
  const floatPills = [
    { text: "6 Cycles/Year", icon: RefreshCw, color: "from-primary/20 to-primary/10 border-primary/30" },
    { text: "3-Day Bootcamps", icon: Flame, color: "from-accent/20 to-accent/10 border-accent/30" },
    { text: "90% Attendance Required", icon: CheckCircle2, color: "from-purple-500/20 to-purple-500/10 border-purple-500/30" }
  ];
      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10 w-full">
        ...
        <div className="lg:col-span-7 text-center lg:text-left">
          ...
          >
            ...
            <span className="font-semibold text-xs tracking-wider uppercase">Soft Skills Training Programme</span>
          </motion.div>
          ...
          >
            Architecting <span className="text-gradient">High-Value</span> Professionals
          </motion.h1>
        ...
        <div className="lg:col-span-5 flex flex-col justify-center items-center relative h-[350px] lg:h-[400px]">
          {floatPills.map((pill, index) => {
            // Coordinate definitions for offset positions in layout
            const positions = [
