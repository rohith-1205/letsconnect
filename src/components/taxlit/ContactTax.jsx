        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-5xl mx-auto mt-8">
              ...
              >
                ...
                <div>
                  ...
                  <div className="space-y-1 text-xs text-textMuted font-light">
                    ...
                    <div className="flex gap-2.5 mt-2 mb-2">
                      <a
                        href={`tel:+91${founder.phone}`}
                        className="inline-flex items-center gap-1.5 text-[10px] text-textPrimary bg-white/5 hover:bg-white/10 px-2.5 py-1.5 rounded-xl border border-white/10 transition-colors"
                      >
                        <Phone className="w-3 h-3 text-teal-400" />
                        <span>Call</span>
                      </a>
                      <a
                        href={`https://wa.me/91${founder.phone}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1.5 text-[10px] text-emerald-400 bg-emerald-500/10 hover:bg-emerald-500/20 px-2.5 py-1.5 rounded-xl border border-emerald-500/20 transition-colors font-medium"
                      >
          ...
          >
            {isSubmitted ? (
              ...
              >
                <div className="w-20 h-20 bg-teal-500/10 border border-teal-500/20 rounded-full flex items-center justify-center text-teal-400 mb-2 relative">
                ...
                <p className="text-textMuted text-sm md:text-base leading-relaxed max-w-md">
                  Thank you for contacting us. You have successfully registered for the free webinar. Our team will reach out to you as soon as possible with details.
                </p>
                
                <div className="h-1.5 w-24 bg-gradient-to-r from-teal-500 to-emerald-500 rounded-full my-2" />
