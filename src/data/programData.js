...
export const pedagogyData = [
  { name: "Hands-on Activities", value: 70, color: "#6C3FEE", description: "Role-plays, games, and simulations" },
  { name: "Peer Feedback", value: 20, color: "#F97316", description: "Interactive assessments and constructive critiques" },
  { name: "Theory", value: 10, color: "#9B59F5", description: "Core frameworks and conceptual learning" }
];
    ...
    topics: [
      {
        ...
        bullets: [
          ...
          "Clarity & Conciseness in Speaking"
        ]
      },
      {
    ...
    topics: [
      {
        ...
        bullets: [
          ...
          "Action Verbs & Key Impact Phrases",
      ...
      },
      {
        ...
        icon: "MessagesSquare",
        bullets: [
          "Initiating & Concluding Discussions",
          "Active Contribution & Turn-taking",
          "Negotiation & Handling Disagreements"
        ]
      }
    ]
  },
    ...
    topics: [
      {
        ...
        icon: "Award",
        bullets: [
          "STAR Methodology for Behavior Questions",
          "Handling Hard Technical/HR Questions",
      ...
      },
      {
        ...
        icon: "Target",
        bullets: [
          "Simulated HR & Technical Rounds",
          "Live Stress-Test Interviews",
          "Individualized Feedback & Scoring"
        ]
      }
    ]
  }
